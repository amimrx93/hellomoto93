...
class Main:
    ...
    def __init__(self):
        ...
        #os.system('espeak -a 200 "Welcome ALIF Mahmud project Random Clone"')
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        #s.system('espeak -a 200 "Random cloning Started ALIF AHMED EMON "')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            #    print(f"\x1b[38;5;196m[ALIF-CP🥴] {uid}|{ps}Ua = \033[1;34m'+pro+'  \033[0;97m")
